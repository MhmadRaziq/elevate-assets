!(function () {
  try {
    ...
    t &&
      ...
      (e._sentryDebugIds[t] = 'd3beb6d6-e5f9-4135-8862-4f89e3756ab0'),
      (e._sentryDebugIdIdentifier = 'sentry-dbid-d3beb6d6-e5f9-4135-8862-4f89e3756ab0'));
  } catch (e) {}
})(),
    ...
    [1700],
    {
      ...
      83828: function (e, t, r) {
        ...
        var n = r(27573),
          ...
          l = r(99279);
        t.default = e => {
          let { chat: t, isStart: r = !1, isCenter: i = !1 } = e,
            c = (0, a.useRef)([]),
            o = (0, a.useRef)(null);
          return (
            (0, a.useEffect)(() => {
              if (r) {
                ...
                t.bubbles.forEach((e, t) => {
                  let n = c.current[t],
                    a = n.offsetHeight + (t > 0 ? (0, l.Wn)(1) : 0);
                  s.ZP.fromTo(
                    n,
                    { opacity: 0 },
                    { opacity: 1, duration: 0.3, ease: 'power2.inOut', delay: 0.45 * t }
                  ),
                    s.ZP.to(o.current, {
                      y: () => (i ? '-'.concat(r(a) / 2) : '-='.concat(a + 30)),
                      opacity: 1,
                      duration: 0.5,
                      ease: 'power2.inOut',
                      delay: 0.45 * t,
                ...
                s.ZP.to(c.current, {
                  ...
                  ease: 'power2.inOut',
                  onComplete: () => {
                    s.ZP.set(c.current, { opacity: 0, y: 0 }), s.ZP.set(o.current, { y: 0 });
                  },
                });
            }, [r]),
            (0, n.jsx)('div', {
              className:
                'relative flex w-full translate-y-[30px] transform-gpu flex-col gap-[1rem]',
              ref: o,
                ...
                (null == t ? void 0 : t.pro) &&
                  (0, n.jsxs)('div', {
                    ...
                    children: [
                      (0, n.jsxs)('div', {
                        className: 'h1',
                        children: [s, (0, n.jsx)('span', { children: t.pro })],
                      }),
                                    ...
                                    children: [
                                      ...
                                      (0, n.jsxs)('td', {
                                        ...
                                        children: [
                                          l,
                                          (
                                            Math.round((+r / (+e.contacts / 1e3)) * 100) / 100
                                          ).toFixed(2),
                                        ],
                                      }),
                                    ],
...
//# sourceMappingURL=1700-0af743b6a677d792.js.map
