    ...
    var e, t, n = {
            ...
            239: e => {
                var t = function(e) {
                    ...
                    }, E(A.prototype), l(A.prototype, s, (function() {
                        return this
                    ...
                    }, E(P), l(P, c, "Generator"), l(P, a, (function() {
                        return this
            ...
            O = {
                canUseIOSVersion: !document.querySelector("html.cn") || (() => {
                    ...
                    const e = document.createElement("input"),
                        ...
                        E = document && document.documentElement.style,
                        A = f(),
                        _ = r.match(/AppleWebKit\/(\d+)/),
                        T = _ && _[1] || "",
                        M = parseFloat(T) || null,
                        j = -1 !== P.indexOf("Mac") ? "macosx" : -1 !== P.indexOf("X11") || -1 !== P.indexOf("Linux") ? "linux" : -1 !== P.indexOf("SunOS") ? "sunos" : "windows",
                        L = Boolean(window.ontransitionend),
                        k = ("transition" in E || "MozTransition" in E) && (!p || p && L),
                        C = k ? "transitionend" : "msTransition" in E ? "MSTransitionEnd" : "WebkitTransition" in E ? "webkitTransitionEnd" : null,
                        x = k ? "animationend" : "msTransition" in E ? "MSAnimationEnd" : "WebkitTransition" in E ? "webkitAnimationEnd" : null;
                    try {
        ...
        const M = (...e) => {
                        ...
                        if (i.bindToken = n.paymentMethod.bindToken, r && !a.cancelled) R(a, r, {
                            ...
                            try {
                                ...
                                r ? N(a) : x(a), j({
                                    ...
                                    error: `${P}: onpaymentmethodselected`
                                })
                            }
                        }));
                        ...
                        R(a, e.updateShippingAddress, i, (t => {
                            try {
                                ...
                                j({
                                    ...
                                    error: `${P}: onshippingcontactselected`
                                }), N(a)
                            }
                        }))
                        ...
                        R(a, e.updateShippingMethod, i, (t => {
                            try {
                                ...
                                j({
                                    ...
                                    error: `${P}: onshippingmethodselected`
                                }), N(a)
                            }
                        }))
            ...
            Y = e => {
                const t = Boolean(window.ApplePaySession && ApplePaySession.supportsVersion && ApplePaySession.supportsVersion(1) && ApplePaySession.canMakePayments),
                    ...
                    i = t && !window ? .acStoreApplePay ? .isACApplePay(),
                    a = (s = $(W.STATE), H.find((e => s === e)) || null);
                var s;
                const c = $(W.INSTALLMENTS),
                    l = a || (n ? i ? r ? o ? V.NIL : V.OLD_SAFARI : V.OLD_DEVICE : V.NOT_SAFARI : V.DISABLED_COUNTRY),
                    u = window.asMetrics && window.asMetrics.relay;
                u && u.getOne && e.config && (e.config.referrerIdentifier = e.config.referrerIdentifier || u.getOne(B));
                const d = {
                    setupFeatures: [],
                    appleCardState: l,
                ...
                return (d.setup ? d.setup.getSetupFeatures() : Promise.resolve([])).then((e => {
                    const t = Array.from(e),
                        n = t.find(X),
                        r = n && n.state || "none",
                        o = t.find((e => "applePay" === e.type)),
                        i = o && o.state || null;
                    return d.appleCardState = a || z[r] || d.appleCardState, d.applePayState = i ? Q[i] || J.API_NIL : d.setup ? J.API_NIL : J.NIL, d.apiStates = {
                        applePay: i && Q[i] ? i : d.setup ? "nil" : "",
                        appleCard: "none" !== r && z[r] ? r : d.setup ? "nil" : ""
                    }, d.setupFeatures = t.filter((e => X(e) && (e => "supported" === e.state || "supplementarySupported" === e.state)(e))), d.supportsInstallments = null === c ? Boolean(n && n.supportsInstallments) : Boolean(c), d
                }))
            },
